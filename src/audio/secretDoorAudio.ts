/**
 * Robust Audio Engine for "Secret Door" (Arctic Monkeys)
 * Uses Web Audio API with preloaded AudioBuffer for 100% glitch-free playback in iframes,
 * with HTMLAudioElement and harmonic synthesizer fallbacks.
 */

const AUDIO_URL = '/secret-door.mp3';
const FALLBACK_STREAM_URL = 'https://blonde-green-sj5ghnaw.edgeone.dev/';
...
class SecretDoorAudioEngine {
  ...
  public totalDuration: number = 42.8; // Duration of the song clip in seconds
